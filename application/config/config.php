...
{
    case 'localhost':
        $config['base_url']	= 'http://localhost/videouri.com/';
    break;
    case 'local.videouri.com':
        $config['base_url'] = 'http://local.videouri.com/';
    break;
...
|
| Leave this BLANK unless you would like to set something other than the default
| system/cache/ directory.  Use a full server path with trailing slash.
|
*/
$config['cache_path'] = '';
...
|
*/
$config['encryption_key'] = 's?Gufre_re$7tuTAq3@U_AbR';
...
$config['cookie_domain']	= 'videouri.com';
$config['cookie_path']		= '/';
