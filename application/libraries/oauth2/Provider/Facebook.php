...
class OAuth2_Provider_Facebook extends OAuth2_Provider
{
	...
	public function get_user_info(OAuth2_Token_Access $token)
	{
        ...
        // EDITED SEP.17.2013: FB doesn't seem to like get_file_contents() anymore!
		// GODADDY seems to like CURL

		/*$url = 'https://graph.facebook.com/me?'.http_build_query(array(
            'access_token' => $token->access_token,
			'appsecret_proof' => hash_hmac('sha256', $token->access_token, "[[[app secret here]]]")
		));
